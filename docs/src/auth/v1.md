...
| ---------------- | ----------- | ------------------------- | ----------------------- |
| `HealthCheck`    | GET         | `/api/v1/health-check`    | Check system health     |
...
| Field    | Type     | Description                      |
| -------- | -------- | -------------------------------- |
| `status` | `string` | Returns `ok` if everything is ok |
...
**File**: [`auth/v1/auth.proto`](https://github.com/shinoda4/sd-grpc-proto/blob/main/auth/v1/auth.proto)
